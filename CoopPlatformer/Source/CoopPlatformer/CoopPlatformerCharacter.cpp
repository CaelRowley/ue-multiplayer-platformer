...
//////////////////////////////////////////////////////////////////////////
// ACoopPlatformerCharacter

ACoopPlatformerCharacter::ACoopPlatformerCharacter()
{
...
void ACoopPlatformerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ACoopPlatformerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACoopPlatformerCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACoopPlatformerCharacter::Look);
	}
	else
	{
...
void ACoopPlatformerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACoopPlatformerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
